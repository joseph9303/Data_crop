...
class VOCXML2COCO:
    def __init__(self, src, dest):
        ...
        self.coco['categories'] = [
                              {"supercategory": "roundabout", "id": 1, "name": "roundabout"},
                              {"supercategory": "tennis-court", "id": 2, "name": "tennis-court"},
                              {"supercategory": "swimming-pool", "id": 3, "name": "swimming-pool"},
                              {"supercategory": "storage-tank", "id": 4, "name": "storage-tank"},
                              {"supercategory": "soccer-ball-field", "id": 5, "name": "soccer-ball-field"},
                              {"supercategory": "small-vehicle", "id": 6, "name": "small-vehicle"},
                              {"supercategory": "ship", "id": 7, "name": "ship"},
                              {"supercategory": "plane", "id": 8, "name": "plane"},
    ...
    def add_image_item(self, file_name, size):
        ...
        image_item['file_name'] = os.path.join(file_name)
